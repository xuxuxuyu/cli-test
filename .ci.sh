...
find ./html -name '*.js' | xargs sed -i "s BUILD_BUILD_ENV_ID $TIME_ID g"
find ./html -name '*.html' | xargs sed -i "s BUILD_BUILD_ENV_ID $TIME_ID g"
find ./html -name '*.json' | xargs sed -i "s BUILD_BUILD_ENV_ID $TIME_ID g"
